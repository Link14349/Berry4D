...
root = os.getcwd()
shields = ["CMakeFiles", "cmake-build-debug", ".idea", ".git"]
lines = 0
sizes = 0
same = root
...
def help():
	print("\033[1m\033[37mBerry4D Data Statistics Tool\033[0m")
	print("\033[1m\033[37mCopyright Berry4DDevelopmentTeam (c) 2020\033[0m")
...
def version():
	print("\033[1m\033[37mBerry4D Data Statistics Tool \033[35mv-1.0.0\033[0m")
	print("\033[1m\033[37mCopyright qianduanXIAOHAOZI (c) 2020\033[0m")
